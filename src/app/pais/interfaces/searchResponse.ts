...
export class Convert {
    public static toCountrySearchResponse(json: string): Country[] {
        return cast(JSON.parse(json), a(r("CountrySearchResponse")));
    }

    public static countrySearchResponseToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("CountrySearchResponse"))), null, 2);
    }
}
